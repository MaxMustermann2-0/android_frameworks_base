...
public class DashListAdapter extends BaseAdapter {
    ...
    public DashListAdapter(Context context, ArrayList<DashItem> items) {
        mContext = context;
        mItems = items;
    }
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        final View itemView = inflater.inflate(R.layout.recents_dash_list_item, null);
        TextView labelTv = (TextView) itemView.findViewById(R.id.label);
        TextView subLabelTv = (TextView) itemView.findViewById(R.id.sublabel);
        ...
        switch (mItems.get(i).getType()) {
            case DashItem.TYPE_APPLICATION:
    ...
    private class LoadMusicImageTask extends AsyncTask<Object, Object, Bitmap> {
        ...
        @Override
        protected Bitmap doInBackground(Object... params) {
            int size = mContext.getResources().getDimensionPixelSize(R.dimen.dash_list_icon_size);
