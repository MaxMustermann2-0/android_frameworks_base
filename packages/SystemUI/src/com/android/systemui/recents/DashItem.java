...
public class DashItem {
    ...
    public DashItem(int type, String label, String subLabel, String launchInfo, String moreLaunchInfo) {
        mType = type;
        mLabel = label;
        mSubLabel = subLabel;
    ...
    public static class Comparator implements java.util.Comparator<DashItem> {

        @Override
        public int compare(DashItem dashItem, DashItem t1) {
            return dashItem.mLabel.toUpperCase().compareTo(t1.mLabel.toUpperCase());
        }
    }
}
